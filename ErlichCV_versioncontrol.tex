...
\fancyfoot[R]{\thepage ~of 7}

\usepackage{lipsum}

\newcommand\textline[4][t]{%
  \par\noindent\parbox[#1]{.2\textwidth}{\raggedright#2}%
 \parbox[#1]{.6\textwidth}{\raggedright#3}% 
 \parbox[#1]{.2\textwidth}{\raggedleft#4}\par\smallskip%
}
...
Democratic governance depends on political
 participation. Democratic theorists have long argued that more
  ...
  \section{\sc Grants \& Scholarships}\\
  {\setlength{\parskip}{0in}
    \textline[t]{2020}{``Nigerians Abroad and at Home: Politics and
      National Identity in a Global Diaspora'' SSHRC Insight Development Grant
      (Co-Investigator)}{CAD  70,413}
    \textline[t]{2020}{``Consortium on Analytics for Data-Driven
      Decision-Making (CAnD3)'' SSHRC Partnership Grant
      (Co-Applicant)}{CAD 2.5 million}
 \textline[t]{2018}{``International experts and
   anti-corruptioninitiatives in a transitional democracy: Ukraine
   police reformsince 2014.'' SSHRC Insight Grant (Co-Investigator)}{CAD 218,310}
\textline[t]{2018}{``Discrétion ou capacité : Utilisation de
  mégadonnées pour modéliser la faculté de réponse des
  gouvernements.'' FRQSC Soutien à la recherche pour la relève
  professorale (PI)}{CAD 56,8163}
\textline[t]{2018}{``Studying Government Accountability and
  Responsiveness with Big Data on Citizen-Government Interactions.''
  SSHRC Insight Development Grant (PI)} {CAD 62,089}
\textline[t]{2018}{``Democracy in disruption? Engaging Canadians to
  face emerging threats.'' SSHRC Connection Grant (Fenwick McKelvey,
  Lead-PI)}{CAD 49,853}
\textline[t]{2017}{``What's in a Tally.'' SSHRC Internal Grant}{CAD 5,000}
\textline[t]{2015}{``Power of the Panopticon.'' \emph{Comparative
    Political Studies: Transparency Special Issue} (with
  S.Bush, L. Prather, Y. Zeira)}{USD11,000}
...
\textline[t]{2015} {Levi-Kaplan Comparative Political Economy Research
  Award} {USD 2,000}
\textline[t]{2014-2015} {Chester A. Fritz Fellowship} {USD 6,400}
\textline[t]{2014}{International Research \& Exchanges
  Board (IREX)} {USD 9,000}
...
% Society Conference, University of Washington, Seattle, October
% 16--19, 2007.
